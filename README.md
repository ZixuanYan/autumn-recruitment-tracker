...
| 内容 | 适用场景 | 下载 |
| --- | --- | --- |
| 秋招求职与简历助手 插件 v5.5.0 | 电脑 Chrome/Edge 网申填表 + 一键收录 + 暂存箱 | [前往插件目录](https://github.com/ZixuanYan/autumn-recruitment-tracker/tree/main/extension) |
...
- 左侧独立入口：总览（统计 + 洞察 + 未来安排）/ 投递记录（表格 / 看板双视图台账，v4.8.0 从总览独立成页）/ 我的简历 / 工具 / 邮件提醒（可选）
- 工具视图集中管理数据安全与云同步，卡片实时显示快照数量与同步连接状态
- 今日投递统计、洞察（阶段分布 / 转化漏斗 / 需要关注 / 城市分布 / 企业性质 / 投递节奏 / 各阶段停留）和未来安排在总览；搜索、阶段筛选、排序、**同企业收纳**（企业级折叠，机构名标在每一行）与表格 / 看板切换在投递记录页
